      ...
      <body className='body'>
        ...
        <div className='container'>
          <div class="flex-container">
            <div class="flex-item item1 itemBox">1</div>
            <div class="flex-item item2 itemBox">2</div>
            <div class="flex-item item3 itemBox">3</div>
            <div class="flex-item item4 itemBox">4</div>
          </div>
        </div>
      </body>
    </div>
